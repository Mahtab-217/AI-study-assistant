    ...
    <div className="w-full flex flex-col ">
        <div className="w-ful min:h-screen flex justify-center items-center">
            <form action={func} className="w-7/12 border p-8 rounded-md flex flex-col gap-4 ">
                ...
                <button 
                disabled={loading}
                className="py-2 w-full rounded-md border bg-linear-60 from-blue-700 to-purple-800 via-blue-500 via-purple-600 text-stone-100 via-blue-800 via-blue-900" type="submit">
